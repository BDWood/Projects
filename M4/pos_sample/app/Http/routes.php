...
Route::post('invoice/{id}/edit', 'InvoiceController@postEdit');
Route::get('invoice/{id}/delete', 'InvoiceController@delete');
Route::get('lineitems/{invoice_id}', 'InvoiceController@getItems');